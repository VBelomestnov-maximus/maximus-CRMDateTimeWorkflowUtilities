...
{
    [TestClass]
    public class GetDayOfWeekTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetDayOfWeekTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetDayOfWeek" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDayUtc()
        {
            ...
            //Expected value
            const string expected = "Thursday";
