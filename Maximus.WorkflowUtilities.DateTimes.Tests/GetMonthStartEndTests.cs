...
{
    [TestClass]
    public class GetMonthStartEndTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetMonthStartEndTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetMonthStartEnd" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDate1UserLocal()
        {
            ...
            //Expected value(s)
            DateTime expected1 = new DateTime(2014, 12, 1, 0, 0, 0);
            ...
            //Test(s)
            Assert.AreEqual(expected1, output["MonthStartDate"]);
            Assert.AreEqual(expected2, output["MonthEndDate"]);
        }
        ...
        public void ValidDate2UserLocal()
        {
            ...
            var inputs = new Dictionary<string, object>
            {
                 { "DateToUse", new DateTime(2015, 2, 3, 5, 0, 0, DateTimeKind.Utc) },
                 { "EvaluateAsUserLocal", true } 
            };

            //Expected value(s)
            DateTime expected1 = new DateTime(2015, 2, 1, 0, 0, 0);
            DateTime expected2 = new DateTime(2015, 2, 28, 23, 59, 59, 999);
        ...
        private static Mock<IOrganizationService> ValidDate2UserLocalSetup(Mock<IOrganizationService> serviceMock)
        {
            ...
            OrganizationResponse localTime = new OrganizationResponse();
            ParameterCollection results = new ParameterCollection { { "LocalTime", new DateTime(2015, 2, 3, 11, 0, 0) } };
            localTime.Results = results;
        ...
        public void ValidDate1Utc()
        {
            ...
            DateTime expected2 = new DateTime(2015, 1, 31, 23, 59, 59, 999);
