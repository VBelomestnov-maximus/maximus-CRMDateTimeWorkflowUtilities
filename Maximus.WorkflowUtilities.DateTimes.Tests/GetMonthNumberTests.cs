...
{
    [TestClass]
    public class GetMonthNumberTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetMonthNumberTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetMonthNumber" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDayUserLocal()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["MonthNumber"]);
        }
