...
{
    [TestClass]
    public class GetDayNumberOfWeekTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetDayNumberOfWeekTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetDayNumberOfWeek" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDayUserLocal()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["DayNumberOfWeek"]);
        }
