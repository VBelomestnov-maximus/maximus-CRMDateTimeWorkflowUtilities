...
namespace Maximus.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class DateDiffHoursTests
    {
        ...
        public DateDiffHoursTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.DateDiffHours" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void MinusOneHour()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["HoursDifference"]);
        }
