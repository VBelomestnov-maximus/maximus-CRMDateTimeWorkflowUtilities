...
{
    [TestClass]
    public class GetDayNumberOfYearTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetDayNumberOfYearTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetDayNumberOfYear" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
