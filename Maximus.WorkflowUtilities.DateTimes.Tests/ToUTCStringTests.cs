...
namespace Maximus.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class ToUTCStringTests
    {
        ...
        public ToUTCStringTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.ToUTCString" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
