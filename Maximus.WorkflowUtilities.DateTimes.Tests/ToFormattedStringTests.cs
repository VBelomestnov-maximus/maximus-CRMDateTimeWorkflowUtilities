...
{
    [TestClass]
    public class ToFormattedStringTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public ToFormattedStringTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.ToFormattedString" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void Date_None()
        {
            ...
            {
                { "DateToUse", new DateTime(2014, 7, 3, 13, 48, 0, 0)},
                { "FormatString", "" },
                { "EvaluateAsUserLocal", false }
            };

            //Expected value
            const string expected = "2014-07-03";
