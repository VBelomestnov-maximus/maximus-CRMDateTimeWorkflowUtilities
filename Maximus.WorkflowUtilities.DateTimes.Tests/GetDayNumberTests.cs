...
{
    [TestClass]
    public class GetDayNumberTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetDayNumberTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetDayNumber" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDayUserLocal()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["DayNumber"]);
        }
