...
namespace Maximus.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class DateDiffMonthsTests
    {
        ...
        public DateDiffMonthsTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.DateDiffMonths" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void MinusOneMonth()
        {
            ...
            //Test
            Assert.AreEqual(expected, output["MonthsDifference"]);
        }

        [TestMethod]
        public void MinusFiveMonths()
        {
            //Target
            Entity targetEntity = null;
        ...
        [TestMethod]
        public void MinusTwentyFiveMonths()
        {
            //Target
            Entity targetEntity = null;
