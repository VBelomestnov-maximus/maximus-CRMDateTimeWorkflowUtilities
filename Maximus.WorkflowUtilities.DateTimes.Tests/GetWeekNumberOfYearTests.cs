...
namespace Maximus.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetWeekNumberOfYearTests
    {
        ...
        public GetWeekNumberOfYearTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetWeekNumberOfYear" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        [TestMethod]
        public void ValidWeekUserLocal1()
        {
            //Target
            ...
            //Invoke the workflow
            var output = InvokeWorkflow(_namespaceClassAssembly, ref targetEntity, inputs, ValidWeekUserLocal1Setup);

            //Test
            Assert.AreEqual(expected, output["WeekNumberOfYear"]);
        }
        ...
        private static Mock<IOrganizationService> ValidWeekUserLocal1Setup(Mock<IOrganizationService> serviceMock)
        {
        ...
        [TestMethod]
        public void ValidWeekUserLocal2()
        {
            //Target
            Entity targetEntity = null;
            ...
            //Invoke the workflow
            var output = InvokeWorkflow(_namespaceClassAssembly, ref targetEntity, inputs, ValidWeekUserLocal2Setup);
        ...
        /// <param name="serviceMock">The Organization Service to mock</param>
        /// <returns>Configured Organization Service</returns>
        private static Mock<IOrganizationService> ValidWeekUserLocal2Setup(Mock<IOrganizationService> serviceMock)
        {
            EntityCollection userSettings = new EntityCollection();
            Entity userSetting = new Entity("usersettings");
            userSetting["timezonecode"] = 20;
            ...
            OrganizationResponse localTime = new OrganizationResponse();
            ParameterCollection results = new ParameterCollection { { "LocalTime", new DateTime(2015, 1, 4, 4, 0, 0) } };
            localTime.Results = results;
