...
{
    [TestClass]
    public class AddTimeStringTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public AddTimeStringTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.AddTimeString" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void AddPlusOne()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 3, 9, 49, 0, 0);
        ...
        public void AddPlusFive()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 3, 13, 53, 0, 0);
        ...
        public void AddPlusFifty()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 5, 11, 38, 0, 0);
        ...
        public void AddMinusOne()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 3, 7, 47, 0, 0);
        ...
        public void AddMinusFive()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 8, 3, 43, 0, 0);
        ...
        public void AddMinusFifty()
        {
            ...
            //Expected value
            DateTime expected = new DateTime(2014, 7, 1, 5, 58, 0, 0);
