...
{
    [TestClass]
    public class GetYearStartEndTests
    {
        #region Class Constructor
        private readonly string _namespaceClassAssembly;
        public GetYearStartEndTests()
        {
            ...
            _namespaceClassAssembly = "Maximus.WorkflowUtilities.DateTimes.GetYearStartEnd" + ", " + "Maximus.WorkflowUtilities.DateTimes";
        }
        #endregion
        ...
        public void ValidDate1UserLocal()
        {
            ...
            //Expected value(s)
            DateTime expected1 = new DateTime(2014, 1, 1, 0, 0, 0);
            ...
            //Test(s)
            Assert.AreEqual(expected1, output["YearStartDate"]);
            Assert.AreEqual(expected2, output["YearEndDate"]);
        }
        ...
        public void ValidDate1Utc()
        {
            ...
            DateTime expected2 = new DateTime(2015, 12, 31, 23, 59, 59, 999);
